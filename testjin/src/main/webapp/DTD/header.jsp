...
<title>HRD 쇼핑물</title>
<link rel="stylesheet" href="${pageContext.request.contextPath }/DTD/hrd_shop.css">
</head>
<body>
	<header>
	...
	<nav>
		<div class="navigation vcenter" >
			...
			<a href="${pageContext.request.contextPath }/boardinser">게시물등록</a>
			<a href="${pageContext.request.contextPath }/boardlist">게시물리스트</a>
